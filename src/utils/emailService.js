...
exports.sendOtpEmail = async (to, otp) => {
  ...
  const payload = {
    sender: { name: 'Sabir Digital Academy', email: process.env.EMAIL_USER },
    to: [{ email: to }],
    subject: 'Your Sabir Digital Academy Password Reset Code',
    textContent:
      `Your Sabir Digital Academy password reset code is: ${otp}\n\n` +
    ...
    htmlContent: `
      <div style="font-family:Arial,sans-serif;max-width:480px;margin:auto;padding:32px;border:1px solid #e1e8f5;border-radius:12px;">
        ...
        <p style="color:#1e4d7b;margin-bottom:24px;">Use the OTP below to reset your Sabir Digital Academy password. It expires in <strong>10 minutes</strong>.</p>
